...
const Home = () => {
  ...
  const { data: advantages, isLoading: isLoadingAdvantages } =
    useFetchData("/advantages");
          ...
          <div className="hero-body">
            <div className="hero-titles G-column-center">
              ...
              <p className="hero-sub-title">
                Инновационные ИТ-решения для вашего успеха. Узнайте о наших
                <span className="desktop-text-wrap">
                  {" "}
                  технологиях для оптимизации производительности и роста
                </span>
              </p>
            </div>
            <div className="hero-info G-column-center">
              <div className="hero-clues">
                <h2 className="hero-clue-title">
                  Создаём IT-решения, которые приносят результаты
                </h2>
                <p className="hero-clue-sub">
                  Мы создаем инновационные ИТ-решения, которые приносят ощутимые
      ...
      <section className="trends-section">
        <div className="container">
          <div className="trends-body">
            <h2 className="trends-title section-title">
            ...
            <div className="trends-items block-cnt G-flex">
              <div className="trends-item trends-big-item ">
                ...
                <div className="trends-info">
                  ...
                  <p className="trends-text block-text">
                    Анализируем бизнес процессы компании, погружаемся в
                    особенности предприятия, изучаем техническую инфраструктуру.
                    <span className="desktop-text-wrap">
                      Разложим по полочкам все технические детали, поможем
                      задать вектор изменений и определиться с его реализацией.
                      Мы разбираемся как в технологиях, так и в бизнесе, а также
                      умеем их объединять.
                    </span>
                  </p>
                </div>
              ...
              <div className="trends-item trends-big-item ">
                ...
                <div className="trends-info">
                  ...
                  <p className="trends-text block-text">
                    Проводим комплексный анализ вашей маркетинговой стратегии, с
                    целью повысить финансовую эффективность и результативность.
                    <span className="desktop-text-wrap">
                      Оцениваем текущее состояние ваших соцсетей, веб
                    </span>
                    -сайтов и маркетоинговых компаний, выявляем точки{" "}
                    <span className="desktop-text-wrap">
                      роста и разрабатываем индивидуальные
                    </span>{" "}
                    рекомендации. Наша цель – сделать вашу коммерциализация
                    более прибыльной и эффективной.
                  </p>
                </div>
              </div>
              ...
              <div className="trends-item ">
                ...
                <div className="trends-info">
                  ...
                  <p className="trends-text block-text">
                    Разрабатываем программные продукты на стыке технологий и
                    инжинерного подхода. Реализуем комплексные проекты от
                    формирования идеи до её воплощения. Подбираем и создаем
                    бизнес-решения под ваши технические условия и ресурсные
                    потребности. Позвольте нашему профессионализму работать на
                    вас.
                  </p>
                </div>
              </div>
                ...
                {advantages?.map((advantage) => (
                  <div className="about-us-item" key={advantage.id}>
                    <div className="about-us-info">
                      <h3 className="trends-title block-title">
                        {advantage.title}
                      </h3>
                      <p className="trends-text block-text">
